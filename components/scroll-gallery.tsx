...
export default function ScrollGallery() {
  ...
  return (
    <section 
      ...
      style={{ height: typeof window !== 'undefined' && window.innerWidth < 768 ? '200vh' : '300vh' }}
    >
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        ...
        >
          {images.map((image, index) => {
            ...
            const opacity = distanceFromActive === 0 ? 1 : Math.max(0.3, 1 - distanceFromActive * 0.4)
            const scale = distanceFromActive === 0 ? 1 : Math.max(0.85, 1 - distanceFromActive * 0.1)
